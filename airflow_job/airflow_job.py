...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflows-projetcs-gds")
    bq_project = Variable.get("bq_project", default_var="bold-crow-468504-g2")
    ...
    batch_details = {
        ...
        "environment_config": {
            "execution_config": {
                ...
                "network_uri": "projects/bold-crow-468504-g2/global/networks/default",
                "subnetwork_uri": "projects/bold-crow-468504-g2/regions/us-central1/subnetworks/default",
            }
        },
    }
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="bold-crow-468504-g2",
        region="us-central1",
